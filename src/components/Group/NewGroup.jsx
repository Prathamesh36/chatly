...
const NewGroup = ({ handleBack, groupMember, setIsCreateGroup }) => {
  ...
  return (
    <div className=" w-full h-full">
      <div className=" flex items-center space-x-10 bg-[#ff4a09] text-white pt-5 px-10 pb-5 rounded-2xl mb-2">
        <BsArrowLeft
          onClick={handleBack}
      ...
      <div className="bg-white w-full h-[79vh] rounded-2xl pt-8">
        ...
        <div className="w-full flex justify-between items-center py-2 px-5">
          <input
            ...
            className="w-full outline-none border-b-2 border-[#ff4a09] px-2  py-2 bg-transparent mt-5"
            type="text"
